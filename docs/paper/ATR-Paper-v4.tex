...
This paper presents a empirical analysis of the AI agent security landscape based on empirical evidence from 30+ CVEs \cite{cve6514,cve53773,cvegit,cve49596,cve59536,postmark,sandworm}, multiple distinct attack classes, 7 published benchmarks \cite{pint,mcptox,asb,aishell,hacka,tensortrust,caibench}, and multiple real-world production incidents in 2025--2026. We make five contributions:
...
\item \textbf{Cascade architecture} that makes full-coverage detection economically viable
