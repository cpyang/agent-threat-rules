...
108 regex-based detection rules.  The scan flagged \textbf{946 skills
...
\textbf{This work} & \textbf{Apr 2026} & \textbf{53,577} & \textbf{946} & \textbf{1.77\%} & \textbf{ATR v1.1.0 (108 rules)} & \textbf{OpenClaw + Skills.sh} \\
\bottomrule
\end{tabular}
\begin{flushleft}
...
model of Snort, Sigma, and YARA---are more robust over time.
...
\textbf{Simple detection works.}  108 regex rules at 5.39\,ms per skill
